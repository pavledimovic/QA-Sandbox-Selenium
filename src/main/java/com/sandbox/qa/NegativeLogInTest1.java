...
public class NegativeLogInTest1 {
	...
	public void negativeLoginTest1() throws InterruptedException {
		...
		// Try to Log In with valid email and invalid password
		Action.enter_email();
		Action.enter_invalid_password();
		...
		if (toast.isDisplayed()) {
			System.out.println("PASS Password incorrect toast is displayed");
		} else {
			System.out.println("FAIL Password incorrect toast is NOT displayed");
			fail();

		}
		if (toastText.equals("Password incorrect")) {
